...
namespace PUNTutorial
{
    public class PlayerMovement : Photon.PunBehaviour
    {
        ...
        //
        private GameObject bikeCircle;
        private GameObject prefabTail;
        ...
        private void Awake()
        {
            ...
            //---
            bikeCircle = GetComponent<TailCreated>().bikeCircle;
            prefabTail = GetComponent<TailCreated>().prefabTail;
        }
